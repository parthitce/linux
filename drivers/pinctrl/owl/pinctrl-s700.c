/*
 * Pinctrl driver for Actions ATM9009 SoC
 *
...
#define P_ETH_TXD2              _GPIOE(4)
#define P_ETH_TXD3              _GPIOE(5)
...
#define P_ETH_RXD2              _GPIOE(6)
#define P_ETH_RXD3              _GPIOE(7)
...
const struct pinctrl_pin_desc s700_pads[] = {
	...
	PINCTRL_PIN(P_ETH_TXD2, "P_ETH_TXD2"),
	PINCTRL_PIN(P_ETH_TXD3, "P_ETH_TXD3"),
	...
	PINCTRL_PIN(P_ETH_RXD2, "P_ETH_RXD2"),
	PINCTRL_PIN(P_ETH_RXD3, "P_ETH_RXD3"),
...
** mfp0_29_28
*/
static unsigned int  owl_mfp0_29_28_pads[] = {
	P_ETH_TXD2,
	P_ETH_TXD3,
};

static unsigned int  owl_mfp0_29_28_funcs[] = {
	OWL_MUX_ETH_RMII,
	OWL_MUX_I2C1,
	OWL_MUX_UART3,
};
...
** mfp0_27_26_rxd2
*/
static unsigned int  owl_mfp0_27_26_rxd2_pads[] = {
	P_ETH_RXD2,
};

static unsigned int  owl_mfp0_27_26_rxd2_funcs[] = {
	OWL_MUX_ETH_RMII,
	OWL_MUX_PWM0,
	OWL_MUX_UART3,
};
...
** mfp0_27_26_rxd3
*/
static unsigned int  owl_mfp0_27_26_rxd3_pads[] = {
	P_ETH_RXD3,
};

static unsigned int  owl_mfp0_27_26_rxd3_funcs[] = {
	OWL_MUX_ETH_RMII,
	OWL_MUX_PWM2,
	OWL_MUX_UART3,
};
...
** mfp1_16_14_d2
*/
static unsigned int  owl_mfp1_16_14_d2_pads[] = {
	P_LCD0_D2,
};

static unsigned int  owl_mfp1_16_14_d2_funcs[] = {
	OWL_MUX_NOR,
	OWL_MUX_SD0,
	OWL_MUX_RESERVED,
	OWL_MUX_PWM3,
...
** mfp1_16_14_d17
*/
static unsigned int  owl_mfp1_16_14_d17_pads[] = {
	P_LCD0_D2,
};

static unsigned int  owl_mfp1_16_14_d17_funcs[] = {
	OWL_MUX_NOR,
	OWL_MUX_SD0,
	OWL_MUX_LCD0,
	OWL_MUX_PWM3,
...
** mfp2_30_29_d2
*/
static unsigned int  owl_mfp2_30_29_d2_pads[] = {
	P_DSI_DP1,
	P_DSI_CP,
	P_DSI_CN,
};

static unsigned int  owl_mfp2_30_29_d2_funcs[] = {
	OWL_MUX_DSI,
	OWL_MUX_LCD0,
	OWL_MUX_RESERVED,
};
...
** mfp2_30_29_d17
*/
static unsigned int  owl_mfp2_30_29_d17_pads[] = {
	P_DSI_DP1,
	P_DSI_CP,
	P_DSI_CN,
};

static unsigned int  owl_mfp2_30_29_d17_funcs[] = {
	OWL_MUX_DSI,
	OWL_MUX_RESERVED,
	OWL_MUX_LCD0,
};
...
**
*/
const struct owl_group s700_groups[] = {
	MUX_PG(mfp0_29_28, 0, 28, 2),

	MUX_PG(mfp0_27_26_rxd2, 0, 26, 2),
	MUX_PG(mfp0_27_26_rxd3, 0, 26, 2),
	...
	MUX_PG(mfp1_16_14_d2, 1, 14, 3),
	MUX_PG(mfp1_16_14_d17, 1, 14, 3),
	...
	MUX_PG(mfp2_30_29_d2, 2, 29, 2),
	MUX_PG(mfp2_30_29_d17, 2, 29, 2),
...
static PAD_PULL_CONF(P_LCD0_D2, 0, 27, 1, 0x1, 0);
...
struct owl_pinconf_pad_info s700_pad_tab[NUM_PADS] = {
...
static struct pinctrl_gpio_range s700_gpio_ranges[] = {
	{
		.name = "s700-pinctrl-gpio",
		.id = 0,
		.base = 0,
		.pin_base = 0,
		.npins = NUM_GPIOS,
...
/*
#define CPU_VDD_CTL	0x28
#define SPS_BASE	0xe01b0100
static struct owl_gpio_pad s700_gpio_pads[] = {
	{.gpio = _GPIOE(2), .reg = CPU_VDD_CTL, .mask = 0x00000200, .bit = 9},
	{.gpio = _GPIOE(3), .reg = CPU_VDD_CTL, .mask = 0x00000100, .bit = 8},
	{.gpio = _GPIOD(28), .reg = CPU_VDD_CTL, .mask = 0x00000080, .bit = 7},
	{.gpio = _GPIOD(29), .reg = CPU_VDD_CTL, .mask = 0x00000040, .bit = 6},
	{.gpio = _GPIOD(30), .reg = CPU_VDD_CTL, .mask = 0x00000020, .bit = 5},
	{.gpio = _GPIOD(31), .reg = CPU_VDD_CTL, .mask = 0x00000010, .bit = 4},
};

struct owl_gpio_pad_data s700_gpio_pad_data = {
	.reg_base = SPS_BASE,
	.reg_size = 0x40,
	.gpio_pads = s700_gpio_pads,
	.size = sizeof(s700_gpio_pads)/sizeof(struct owl_gpio_pad),
};
*/
...
static int s700_pinctrl_probe(struct platform_device *pdev)
{
	...
	return owl_pinctrl_probe(pdev, &s700_pinctrl_info);
}

static int s700_pinctrl_remove(struct platform_device *pdev)
{
	return owl_pinctrl_remove(pdev);
}

static struct of_device_id s700_pinctrl_of_match[] = {
	{ .compatible = "actions,s700-pinctrl", },
	{}
};
MODULE_DEVICE_TABLE(of, s700_pinctrl_of_match);

static struct platform_driver s700_pinctrl_driver = {
	.probe = s700_pinctrl_probe,
	.remove = s700_pinctrl_remove,
	.driver = {
		.name = "pinctrl-s700",
		.owner = THIS_MODULE,
...
MODULE_DESCRIPTION("Pin control driver for Actions S700 SoC");
MODULE_LICENSE("GPL");
