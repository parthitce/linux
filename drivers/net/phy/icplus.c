...
static int ip101g_probe(struct phy_device *phydev)
{
	int reg_val;
	int cnt = 0;
	...
	phy_write(phydev, 0xf, 0x10);
	phy_write(phydev, 0x11, (~(0x1<<15)));
	phy_write(phydev, 0x1d, (~(0x1<<2)));
	phy_write(phydev, 0xf, 0x0);
	return 0;
}
