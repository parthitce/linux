...
static int _atc2603c_auxadc_getraw_icm_chn(uint channel,
					   const struct
...
static int _atc2603c_auxadc_usertran_dbg_i_mode(uint raw_val,
						const struct
						atc260x_auxadc_chn_hwinfo
						*ch_info,
						struct atc260x_dev *atc260x)
...
static int _atc2603c_auxadc_usertran_dbg_rem_mode(uint raw_val,
						  const struct
						  atc260x_auxadc_chn_hwinfo
						  *ch_info,
						  struct atc260x_dev *atc260x)
...
static int _atc2603c_auxadc_usertran_icm(uint raw_val,
					 const struct atc260x_auxadc_chn_hwinfo
...
static const struct atc260x_auxadc_chn_hwinfo sc_atc2603c_chn_hwinfos_bati = {
...
static const struct atc260x_auxadc_chn_hwinfo sc_atc2603c_chn_hwinfos_vbusi = {
...
static const struct atc260x_auxadc_chn_hwinfo sc_atc2603c_chn_hwinfos_walli = {
...
static const struct atc260x_auxadc_chn_hwinfo sc_atc2603c_chn_hwinfos_chgi = {
...
static const struct atc260x_auxadc_hwinfo sc_atc2603c_auxadc_hwinfo = {
	.channels = 17,
	.chn_names = {
		      "BATV", "BATI", "VBUSV", "VBUSI", "SYSPWRV", "WALLV",
		      "WALLI", "CHGI",
	...
	.chn_hwinfos = {
			...
			&sc_atc2603c_chn_hwinfos_bati,
			&sc_atc2603c_chn_hwinfos_vbusv,
			&sc_atc2603c_chn_hwinfos_vbusi,
			&sc_atc2603c_chn_hwinfos_syspwrv,
			&sc_atc2603c_chn_hwinfos_wallv,
			&sc_atc2603c_chn_hwinfos_walli,
			&sc_atc2603c_chn_hwinfos_chgi,
...
static int _atc2609a_auxadc_usertran_ictemp_adj(uint raw_val,
						const struct
						atc260x_auxadc_chn_hwinfo
						*ch_info,
						struct atc260x_dev *atc260x)
					 ...
					 *ch_info)
{
	...
	if (unlikely(ch_info->getraw_func)) {
		...
		raw_value =
		    ((uint) ret >> ch_info->
		     dat_bit_offs) & ((1U << ch_info->dat_bit_cnt) - 1U);
	}
	return raw_value;
}
...
static int _atc2603c_auxadc_dev_init(struct atc260x_dev *atc260x)
{
	...
	atc260x->auxadc_hwinfo = &sc_atc2603c_auxadc_hwinfo;
...
static int _atc2609a_auxadc_dev_init(struct atc260x_dev *atc260x)
{
	...
	ictemp_adj = 0;
	ret =
	    atc260x_reg_write(atc260x, ATC2609A_PMU_ICTEMPADC_ADJ, ictemp_adj);
	if (ret) {
		dev_err(atc260x->dev,
			"%s() failed to set ic_temp adjuest value\n", __func__);
	}
