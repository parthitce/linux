...
static const struct mfd_cell sc_atc2603a_cells[] = {
	...
	/* Power */
	{
	 ...
	 .of_compatible = "actions,atc260x-charger",
	 },
...
static const struct resource atc2603c_charger_resources[] = {
	{
	 .start = ATC2603C_IRQ_OT,
	 .end = ATC2603C_IRQ_OT,
	 .flags = IORESOURCE_IRQ,
	 },
};
...
static const struct mfd_cell sc_atc2603c_cells[] = {
	...
	/* Power */
	{
	 .name = "atc2603c-charger",
	 .of_compatible = "actions,atc2603c-charger",
	 .num_resources = ARRAY_SIZE(atc2603c_charger_resources),
	 .resources = atc2603c_charger_resources,
	 },
...
/* --------------  ATC2609A ------------------------------------------------- */
static struct resource atc2609a_ir_resources[] = {
	{
...
static const struct resource atc2609a_charger_resources[] = {
	{
	 .start = ATC2609A_IRQ_OT,
	 .end = ATC2609A_IRQ_OT,
	 .flags = IORESOURCE_IRQ,
	 },
};
...
static const struct mfd_cell sc_atc2609a_cells[] = {
	 ...
	 },
	{
	 ...
	 .of_compatible = "actions,atc2609a-ir",
	 .num_resources = ARRAY_SIZE(atc2609a_ir_resources),
	 .resources = atc2609a_ir_resources,
	 },
	...
	/* Charger */
	{
	 .name = "atc2609a-charger",
	 .of_compatible = "actions,atc2609a-charger",
	 .num_resources = ARRAY_SIZE(atc2609a_charger_resources),
	 .resources = atc2609a_charger_resources,
	 },

	/* Battery */
	{
	 .name = "atc2609a-battery",
	 .of_compatible = "actions,atc2609a-battery",
	 },
...
static const struct mfd_cell *const
    sc_atc260x_mfd_cell_def_tbl[ATC260X_ICTYPE_CNT] = {
