...
static struct owl_pll_clock s900_pll_clks[] __initdata = {
	{ CLK_CORE_PLL,   "core_pll", NULL, CLK_IS_ROOT, CMU_COREPLL, 24000000, 9, 0, 8,  5, 107, 0, NULL},
	{ CLK_DEV_PLL,    "dev_pll",  NULL, CLK_IS_ROOT, CMU_DEVPLL,  6000000, 8, 0, 8, 20, 180, 0, NULL},
	{ CLK_DDR_PLL,    "ddr_pll",  NULL, CLK_IS_ROOT, CMU_DDRPLL,  24000000, 8, 0, 8,  5,  45, 0, NULL},
	{ CLK_NAND_PLL,   "nand_pll", NULL, CLK_IS_ROOT, CMU_NANDPLL,  6000000, 8, 0, 8,  4, 100, 0, NULL},
	{ CLK_DISPLAY_PLL, "display_pll", NULL, CLK_IS_ROOT, CMU_DISPLAYPLL, 6000000, 8, 0, 8, 20, 180, 0, NULL},
	{ CLK_ASSIST_PLL, "assist_pll", NULL, CLK_IS_ROOT, CMU_ASSISTPLL, 500000000, 0, 0, 0, 0, 0, CLK_OWL_PLL_FIXED_FREQ, NULL},
	{ CLK_AUDIO_PLL,  "audio_pll",  NULL, CLK_IS_ROOT, CMU_AUDIOPLL, 0, 4, 0, 1, 0, 0, 0, clk_audio_pll_table},
};

static const char *cpu_clk_mux_p[] __initdata = {"losc", "hosc", "core_pll", "dev_clk"};
static const char *dev_clk_p[] __initdata = { "hosc", "dev_pll", };
static const char *noc_clk_mux_p[] __initdata = { "dev_clk", "assist_pll"};
static const char *dmm_clk_mux_p[] __initdata = { "dev_clk", "nand_pll", "assist_pll", "ddr_pll"};

static const char *bisp_clk_mux_p[] __initdata = { "assist_pll", "dev_clk"};
static const char *csi_clk_mux_p[] __initdata = { "display_pll", "dev_clk"};
static const char *de_clk_mux_p[] __initdata = { "assist_pll", "dev_clk"};
static const char *eth_mac_clk_mux_p[] __initdata = { "assist_pll"};
static const char *gpu_clk_mux_p[] __initdata = { "dev_clk", "display_pll", "", "ddr_pll"};
static const char *hde_clk_mux_p[] __initdata = { "dev_clk", "display_pll", "", "ddr_pll"};
static const char *i2c_clk_mux_p[] __initdata = { "assist_pll"};
static const char *imx_clk_mux_p[] __initdata = { "assist_pll", "dev_clk"};
static const char *lcd_clk_mux_p[] __initdata = { "display_pll", "nand_pll", };
static const char *nand_clk_mux_p[] __initdata = { "dev_clk", "nand_pll", };
static const char *pwm_clk_mux_p[] __initdata = { "hosc"};
static const char *sd_clk_mux_p[] __initdata = { "dev_clk", "nand_pll", };
static const char *sensor_clk_mux_p[] __initdata = { "hosc", "bisp"};
static const char *speed_sensor_clk_mux_p[] __initdata = { "hosc",};
static const char *spi_clk_mux_p[] __initdata = { "ahb_clk"};
static const char *thermal_sensor_clk_mux_p[] __initdata = { "hosc",};
static const char *uart_clk_mux_p[] __initdata = { "hosc", "dev_pll"};
static const char *vce_clk_mux_p[] __initdata = { "dev_clk", "display_pll", "assist_pll", "ddr_pll"};
static const char *i2s_clk_mux_p[] __initdata = { "audio_pll", };
static const char *pcm_clk_mux_p[] __initdata = { "audio_pll", };

static const char *edp_clk_mux_p[] __initdata = { "assist_pll", "display_pll" };
...
static struct owl_mux_clock s900_mux_clks[] __initdata = {
	...
	{ CLK_DEV,  "dev_clk", dev_clk_p, ARRAY_SIZE(dev_clk_p), NULL, CMU_DEVPLL, 12, 1, 0, "dev_clk" },
...
static struct owl_gate_clock s900_gate_clks[] __initdata = {
	...
	{ CLK_HDMI_DEV,  "hdmi_dev", NULL, 0, CMU_DEVCLKEN1, 3, 0, "hdmi_dev"},
