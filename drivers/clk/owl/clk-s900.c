...
static struct owl_fixed_rate_clock s900_fixed_rate_clks[] __initdata = {
	...
	{ CLK_24M,      "24M_diff", NULL, CLK_IS_ROOT, 24000000, },
};
...
static const char *cpu_clk_mux_p[] __initdata = {"losc", "hosc", "core_pll", };
static const char *dev_clk_p[] __initdata = { "hosc", "dev_pll", };
static const char *noc_clk_mux_p[] __initdata = { "dev_clk", "assist_pll"};
static const char *dmm_clk_mux_p[] __initdata = { "dev_clk", "nand_pll", "assist_pll", "ddr_clk_src"};
...
static const char *gpu_clk_mux_p[] __initdata = { "dev_clk", "display_pll", "", "ddr_clk_src"};
static const char *hde_clk_mux_p[] __initdata = { "dev_clk", "display_pll", "", "ddr_clk_src"};
...
static const char *vce_clk_mux_p[] __initdata = { "dev_clk", "display_pll", "assist_pll", "ddr_clk_src"};
...
static struct owl_gate_clock s900_gate_clks[] __initdata = {
	...
	{ CLK_24M_EDP,		"24M_edp",		"24M_diff", 0, CMU_EDPCLK, 8, 0, "24M_edp"},
