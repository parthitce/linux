...
static struct resource mali_gpu_resources_m450_mp4[] = {
	MALI_GPU_RESOURCES_MALI450_MP4_PMU(0x6F040000, 35, 35, 35, 35, 35, 35, 35, 35, 35, 35, 35)
};
...
static struct mali_gpu_device_data mali_gpu_data = {
	...
	*/
	...
	.get_clock_info = mali_get_clock_info,/*mali_get_clock_info*/
	.get_freq = mali_get_freq_step,/*mali_get_freq_step*/
	.set_freq = mali_set_freq_step,/*mali_set_freq_step*/
};
...
int mali_platform_device_register(void)
{
	...
	if (1/*mali_read_phys(0x6F000000) == 0x40601450*/) {
...
#if USING_GPU_POLICY
    /*create gpu freq fun file system*/
	owl_gpu_fun_add_attr(&device->dev.kobj);
#endif /* USING_GPU_POLICY */
