...
#ifndef _OWL_DRM_GEM_H_
#define _OWL_DRM_GEM_H_

#define to_owl_gem_obj(x)	container_of(x,\
			struct owl_drm_gem_obj, base)

/*
 * owl drm gem buffer structure.
 *
...
/*
 * owl drm buffer structure.
 *
 * @base: a gem object.
 *	- a new handle to this gem object would be created
 *	by drm_gem_handle_create().
 * @buffer: a pointer to owl_drm_gem_buffer object.
...
struct page **owl_gem_get_pages(struct drm_gem_object *obj, gfp_t gfpmask);
...
int owl_drm_gem_userptr_ioctl(struct drm_device *dev, void *data,
				      struct drm_file *file_priv);
...
/* free gem object. */
void owl_drm_gem_free_object(struct drm_gem_object *gem_obj);
