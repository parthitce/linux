...
#define USB_ERR_PLACE               pr_err("err:%s,%d\n", __FILE__, __LINE__)
...
int umonitor_core_init(umonitor_api_ops_t *core_ops, umon_port_config_t *port_config, void __iomem  *base, struct monitor_data *monitor_owl);
