...
#ifdef DEBUG_EP_ERR
#define EP_ERRINFO(fmt,args...)  dev_info(fmt,##args)
#else
#define EP_ERRINFO(fmt, args...) do {} while (0)
#endif

#ifdef DEBUG_TIMEOUT
#define DBG_TIMEOUT(fmt, args...) printk(fmt, ## args)
#else
#define DBG_TIMEOUT(fmt, args...) do{} while(0)
#endif

#ifdef DEBUG_EP_CONFIG
#define EP_CFGINFO(fmt,args...)  dev_info(fmt,##args)
#else
#define EP_CFGINFO(fmt,args...)  do{} while(0)
#endif
