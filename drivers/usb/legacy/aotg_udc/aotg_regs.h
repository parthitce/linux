...
#define EP0INDAT0               0x00000100
#define HCEP0OUTDAT             0x00000100

#define EP0INDATA               0x00000100
...
#define SETUPDAT0               0x00000180
//#define SETUPDATA            0x00000184
...
#define OUTXZEROPCKIRQ          0x00000448
#define OUTXZEROPCKIEN          0x0000044a
...
#define USB0_ECS_BVALID         (1 << 11)
#define CMU_USBPLL_USBPLL0EN    (1 << 12)
#define CMU_USBPLL_USBPLL1EN    (1 << 13)

#define CMU_DEVRST1_USB0        (1 << 3)
#define CMU_DEVRST1_USB1        (1 << 4)

#define CMU_USB2PLL_0CCE        (1 << 8)
#define CMU_USB2PHY_0CE         (1 << 10)
#define CMU_USB2PLL_0EN         (1 << 12)

#define USB_ECS_WKUPBVLDEN      (1<<23)
#define USB_ECS_DEVICE_MOD      (0xf<<12)


#define USB_EXTENAL_IRQ_ENABLE  (1 << 7)


#define FIFOAUTO_BIT	(u8)(1<<5)
