...
#ifndef __S900_ISP_H__
#define __S900_ISP_H__
...
#define S900A_ISP_HOST0  0
#define S900A_ISP_HOST1  1
...
typedef struct {
	...
	unsigned char color_seq;        /*0: BG/GR, U0Y0V0Y1, 1: GR/BG, V0Y0U0Y1, 2: GB/RG, Y0U0Y1V0, 3: RG/GB, Y0V0Y1U0*/
} isp_setting_t;
