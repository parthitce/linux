...
ISP 接口参数设置
*/
static  isp_setting_t isp_setting = {
	.hs_pol = 1,           				/*0: active low 1:active high*/
	.vs_pol = 0,           				/*0: active low 1:active high*/
	.clk_edge = 0,         				/*0: rasing edge 1:falling edge*/
	.color_seq = COLOR_SEQ_UYVY,        /*0: BG/GR, U0Y0V0Y1, 1: GR/BG, V0Y0U0Y1, 2: GB/RG, Y0U0Y1V0, 3: RG/GB, Y0V0Y1U0*/
};
...
static const struct regval_list module_init_regs[] = {
	...
	{1, 0x3016, 0x1c}, /* drive strength of low speed = 1x, bypass latch of hs_enable*/
...
#ifdef Flip
#ifdef Mirror
	{1, 0x3820, 0xc6}, /* vsub48_blc on, vflip_blc on, Flip on, vbinf on*/
	...
	{1, 0x5000, 0xff}, /* lenc_en, awb_gain_en, lcd_en, avg_en, bc_en, WC_en, blc_en                    */
	{1, 0x5001, 0x0d}, /* manual blc offset, avg after LCD */
	{1, 0x5002, 0x32}, /* dpc_href_s, sof_sel, bias_plus   */
	{1, 0x5003, 0x0c}, /* bias_man*/
	{1, 0x5004, 0xff}, /* uv_dsn_en, rgb_dns_en, gamma_en, cmx_en, cip_en, raw_dns_en, strech_en, awb_en*/
	...
	/* Raw de-noise auto*/
	{1, 0x5280, 0x15}, /* m_nNoise YSlop = 5, Parameter noise and edgethre calculated by noise list*/
	...
	{1, 0x5300, 0xc5}, /*m_bColorEdgeEnable, m_bAntiAlasing on, m_nNoise YSlop = 5*/
	...
	{1, 0x538c, 0x10}, /* Sing bit [2][1], [2][0], [1][1], [1][0], [0][1], [0][0]*/
	/* Gamma*/
	...
	{1, 0x5506, 0x00}, /* uuv_dns_psra_man dis, m_nShadowExtraNoise = 0*/
	/* UV adjust*/
	{1, 0x5600, 0x06}, /*fixy off, neg off, gray off, fix_v off, fix_u off, contrast_en, saturation on*/
	{1, 0x5603, 0x40}, /*sat U*/
	{1, 0x5604, 0x20}, /*sat V*/
	{1, 0x5608, 0x00},
...
static const struct regval_list module_720p_regs[] = {
	...
	{1, 0x3820, 0xc4}, /*vsub48_blc on, vflip_blc on, Flip on, vbinf off,*/
	{1, 0x3821, 0x00}, /*hbin off                                        */
	{1, 0x3820, 0xc4}, /*vsub48_blc on, vflip_blc on, Flip on, vbinf off,*/
	{1, 0x3821, 0x04}, /*Mirror on, hbin off    */
	{1, 0x382a, 0x00}, /*fixed VTS              */
