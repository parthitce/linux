...
static struct mipi_setting mipi_sensor_setting = {
    ...
    .clk_settle_time = 13,	//7
    .clk_term_time = 0,    //5
    .data_settle_time = 13,  //7
    .data_term_time = 0,    //5
    .crc_en = 1,
    .ecc_en = 1,
    .hclk_om_ent_en = 0,
...
/* Office Colour Temperature : 3500K - 5000K ,ó?1aμ? */
...
/* Home Colour Temperature : 2500K - 3500K ￡?°×3?μ? */
...
{
	{1,0xfe,0x01},
	{1,0x3c,0x20}, //0x00 10  20 30 	20 14 12 8 fps 40 default
	{1,0xfe,0x00},
	ENDMARKER,
};
#if 0
