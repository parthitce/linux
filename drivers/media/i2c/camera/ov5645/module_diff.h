...
static const struct regval_list module_init_regs[] = {
	...
	{1, 0x5000, 0xa7}, /* Lenc on, raw gamma on, BPC on, WPC on, color interpolation on */
	{1, 0x5001, 0x83}, /* SDE on, scale off, UV adjust off, color matrix on, AWB on     */
	{1, 0x501d, 0x00},
	...
	{1, 0x5789, 0x08}, /*1x */
	{1, 0x578a, 0x02}, /*8x – set in 5783 */
	{1, 0x578b, 0x01}, /*12x – set in 5784*/
	{1, 0x578c, 0x01}, /*128x*/
	/*black pixel threshold  */
	{1, 0x578d, 0x0c}, /*1x */
	{1, 0x578e, 0x02}, /*8x – set in 5783 */
	{1, 0x578f, 0x01}, /*12x – set in 5784*/
	ENDMARKER,
};
...
int sensor_af_fw_regs[] = {
	...
	0x04, 0x06, 0x06, 0x00, 0x02, 0x64, 0x00, 0xcc, 0x50, 0x28, 0x1e, 0x08, 0x08, 0x01, 0x1e, 0x1e, /*0x8e80 */
