...
/*调试信息宏定义开关*/
#define CAMERA_DEBUG_INFO           "Camera"
...
#define DBG_INFO(fmt, args...)   \
	printk(KERN_INFO"[" CAMERA_DEBUG_INFO "] (INFO) line:%d--%s() "fmt"\n",\
...
#define DBG_ERR(fmt, args...)   \
	printk(KERN_ERR"[" CAMERA_DEBUG_INFO "] (ERR) line:%d--%s() "fmt"\n",\
	__LINE__, __FUNCTION__, ##args)
#else
...
static int camera_i2c_read(struct i2c_adapter *i2c_adap,
	unsigned int data_width, unsigned int reg, unsigned int *dest);
static int camera_i2c_write(struct i2c_adapter *i2c_adap,
	unsigned int data_width, unsigned int reg, unsigned int src);
static int camera_write_array(struct i2c_adapter *i2c_adap,
	const struct regval_list *vals);
static struct camera_module_priv *to_camera_priv
...
static int  module_set_auto_white_balance
	(struct v4l2_subdev *sd, struct v4l2_ctrl *ctrl);
static int  module_set_white_balance_temperature
	(struct v4l2_subdev *sd, struct v4l2_ctrl *ctrl);
static int  module_set_exposure_auto
	(struct v4l2_subdev *sd, struct v4l2_ctrl *ctrl);
static int  module_set_scene_exposure
	(struct v4l2_subdev *sd, struct v4l2_ctrl *ctrl);



static int  module_set_mbusformat
	(struct i2c_client *client, const struct module_color_format *cfmt);
static int  module_s_mirror_flip
	(struct v4l2_subdev *sd, struct v4l2_ctrl *ctrl);
...
static int  module_set_af_region
	(struct v4l2_subdev *sd, struct v4l2_ctrl *ctrl);
...
static int  module_get_af_status
	(struct camera_module_priv *priv, struct v4l2_ctrl *ctrl);
