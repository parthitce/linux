...
#define CH_COL_START(x)                        (0x1FFF & (x))
#define CH_COL_END(x)                          ((0x1FFF & (x)) << 16)

#define CH_ROW_START(x)                        (0xFFF & (x))
#define CH_ROW_END(x)                          ((0xFFF & (x)) << 16)

#define CH_PRELINE_NUM_MASK                    (0xFFF << 16)
#define CH_PRELINE_NUM(x)                      ((0xFFF & (x)) << 16)
...
#define MODULE_OUT_FMT_NV12                     (0x0 << 8)
#define MODULE_OUT_FMT_NV21                     (0x1 << 8)
#define MODULE_OUT_FMT_YUV422SP                 (0x2 << 8)
#define MODULE_OUT_FMT_YUV422P                  (0x3 << 8)

#define MODULE_CTL_CHANNEL1_INTF_MIPI           (0x1 << 8)
#define MODULE_CTL_CHANNEL1_INTF_PARAL          (0x0 << 8)
#define MODULE_CTL_CHANNEL_OUTPUT_SEQ_MASK      (0x3 << 8)
...
#define MODULE_CTL_CHANNEL_HSYNC_ACTIVE_HIGH   (0x1 << 1)
#define MODULE_CTL_CHANNEL_VSYNC_ACTIVE_HIGH   (0x1 << 0)
#define MODULE_CTL_CHANNEL_COLOR_SEQ_MASK      (0x3<<4)
#define MODULE_CTL_CHANNEL_COLOR_SEQ_UYVY      (0x0<<4)
#define MODULE_CTL_CHANNEL_COLOR_SEQ_VYUY      (0x1<<4)
#define MODULE_CTL_CHANNEL_COLOR_SEQ_YUYV      (0x2<<4)
#define MODULE_CTL_CHANNEL_COLOR_SEQ_YVYU      (0x3<<4)

#define MODULE_CTL_CHANNEL_RAW_CLOLR_SEQ_MASK  (0x1<<0)
