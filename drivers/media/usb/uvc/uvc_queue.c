 ...
 */
#ifdef CONFIG_ASOC_CAMERA
int uvc_get_buffer_size(struct uvc_streaming *stream, 
	...
	*/	
	{
	   ...
	   for (plane = 0; plane < vb->num_planes; ++plane) {
	       ...
	       dma_ops->sync_single_for_device(NULL, vb->v4l2_planes[plane].m.userptr, PAGE_ALIGN(vb->v4l2_planes[plane].length), DMA_TO_DEVICE);
	       dma_ops->sync_single_for_cpu(NULL, vb->v4l2_planes[plane].m.userptr, PAGE_ALIGN(vb->v4l2_planes[plane].length), DMA_FROM_DEVICE);
