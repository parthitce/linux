...
/*added for one frame split to two parts, or one
 *frame with err data problems, ActionsCode(author:liyuan, change_code)*/
...
#ifdef CONFIG_ASOC_CAMERA
extern struct miscdevice  uvc_misc_device;
#endif
