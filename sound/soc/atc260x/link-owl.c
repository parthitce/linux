...
//extern int atc2603a_audio_get_pmu_status();
//extern int atc2603c_audio_get_pmu_status();
...
static int __init s900_link_init(void)
{
	...
	{
		dn = s900_audio_get_device_node(audio_atc2603a_link_node);
		if (!dn)
			goto no_device_node;
	}
