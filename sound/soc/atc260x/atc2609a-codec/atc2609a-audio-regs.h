...
#ifndef __ATC2609A_AUDIO_REGS_H__
#define __ATC2609A_AUDIO_REGS_H__
...
#define DAC_DIGITALCTL_DMFR		(0x1 << 2)
#define DAC_DIGITALCTL_DMFL		(0x1 << 3)
/*
...
/* ADC_CTL */
#define ADC_CTL_ADCIS_SFT		(0)
#define ADC_CTL_AD0REN			(0x1 << 2)
#define ADC_CTL_AD0REN_SFT		(2)
#define ADC_CTL_AD0LEN			(0x1 << 3)
#define ADC_CTL_AD0LEN_SFT		(3)
#define ADC_CTL_MIC0FDSE		(0x1 << 4)
#define ADC_CTL_MIC0FDSE_SFT		(4)
#define ADC_CTL_MIC0REN			(0x1 << 5)
#define ADC_CTL_MIC0REN_SFT		(5)
#define ADC_CTL_MIC0LEN			(0x1 << 6)
#define ADC_CTL_MIC0LEN_SFT		(6)
#define ADC_CTL_VMICEXST		(((x) & 0x3) << 7)
#define ADC_CTL_VMICEXST_SFT		(7)
#define ADC_CTL_VMICEXEN		(0x1 << 9)
#define ADC_CTL_VMICEXEN_SFT		(9)
#define ADC_CTL_FMREN			(0x1 << 13)
#define ADC_CTL_FMREN_SFT		(13)
#define ADC_CTL_FMLEN			(0x1 << 14)
#define ADC_CTL_FMLEN_SFT		(14)
#define ADC_CTL_VMICINEN		(0x1 << 15)
#define ADC_CTL_VMICINEN_SFT		(15)
...
#endif  /* ifndef __ATC2609A_AUDIO_REGS_H__ */
