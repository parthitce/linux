 ...
 *    "BATV", "ICM", "QMAX", "QREM", "QAVI", "DELTAQ"
 * */
...
enum {
	...
	ATC260X_PSTORE_TAG_FW_BOOT_FROM_S2,     /* S2唤醒标志，唤醒后由BOOT写入，用于kernel判断是否真正进了休眠 */
	ATC260X_PSTORE_TAG_DIS_MCHRG,           /* 重启不进mini_charger */
	ATC260X_PSTORE_TAG_SHDWN_NOT_DEEP,      /* enter deep power down or not after upgrade*/
	...
	ATC260X_PSTORE_TAG_GAUGE_CAP,           /* 保存软电量计电量 (20bits) */
